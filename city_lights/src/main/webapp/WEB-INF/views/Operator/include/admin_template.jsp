...
<script type="text/javascript"
	src="<spring:url value='/admin_dashboard.js'/>"></script>
</head>
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		...
		<a class="navbar-brand"
			href="<spring:url value='/Operator/Dashboard'/>">City Light</a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="<spring:url value='/Operator/Dashboard'/>"> <i
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					data-parent="#exampleAccordion"> <i class="fa fa-fw fa-sitemap"></i>
						<span class="nav-link-text">Work ${sessionScope.countNew}</span>
				</a>
					<ul class="sidenav-second-level collapse" id="layout">
						<li><a href="<spring:url value='/Operator/powerCutRequest'/>">
								<i class="fa fa-fw fa-link"></i>Power Cut Request
								${sessionScope.countNew}
						</a></li>
						<li><a href="<spring:url value='/Operator/Bills'/>"> <i
								class="fa fa-fw fa-link"></i>Billing
						</a></li>
					</ul></li>
			</ul>
			</li>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class=" btn btn-danger nav-link"
					data-toggle="modal" data-target="#exampleModal"> Logout </a></li>
			</ul>
		</div>
	</nav>