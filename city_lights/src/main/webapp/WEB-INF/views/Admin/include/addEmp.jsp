...
<div class="content-wrapper">
	<div class="container-fluid">
		...
		<div class="container">
			<form action='<spring:url value="/Admin/addEmp"/>' method="post"
				enctype="multipart/form-data"
				onsubmit="return checkCheckBoxes(this);">
				<h2 class="text-center">Sign Up For City Lights</h2>
				<div class="row jumbotron">
					<div class="col-sm-6 form-group">
						<label for="name-f">Employee Type</label> <select type="text"
							class="form-control" name="type" required>
							<option value="Operator">Operator</option>
							<option vlaue="Line Men">Line Men</option>
							</select>
						<p>${requestScope.nameerror}</p>
					</div>
					<div class="col-sm-6 form-group">
						<label for="name-f">Employee Name</label> <input type="text"
					...
					<div class="col-sm-6 form-group">
						<label for="address-1">Address Line-1</label> <input
							type="address" class="form-control" name="streetLine"
							id="streetLine" placeholder="Locality/House/Street no." required>
						<p>${requestScope.localityerror}</p>
					</div>
					<div class="col-sm-6 form-group">
						<label for="address-1">District</label> <input type="text"
							class="form-control" name="district" id=""
							district""
